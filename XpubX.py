...
# 제외할 단어 리스트
exclude_keywords = ['hotel','Co. Ltd.','resort','Lounge','Karaoke','Restaurant',
                    'pub','Club','Train Station','Bus Station','bar', 'Conrad','Hyatt', 'Railway Ticket',
                    'The Westin', 'Ritz Carlton', 'Railway Station', 'inn', 'Hilton', '가라오케', '인터콘티넨탈',
                    '콘레드',  '호텔', '공항', '하얏트', '역', '호스텔', '힐튼', 'tours', '료칸', '홀리데이 인', '국제공항',
                    '리조트', 'Night club','식당','레스토랑','HosteI','Hostel']
